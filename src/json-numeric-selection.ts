...
import {
  ...
  type LosslessJsonNumberFailureKind,
...
} as const satisfies Record<JsonPrimitiveFailureKind, JsonNumericSelectionErrorCode>
...
} as const satisfies Record<LosslessJsonNumberFailureKind, JsonNumericSelectionErrorCode>

function failLosslessNumber(
  kind: LosslessJsonNumberFailureKind,
  message: string,
  options?: ErrorOptions,
): never {
  fail(message, LOSSLESS_NUMBER_ERROR_CODES[kind], options)
}
